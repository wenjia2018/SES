...
#' ---
#' title: skin color3 and race additive model
...
#' * "race ethnicity":  "raceethnicity_Hispanic" and "raceethnicity_NonHblack" with "raceethnicity_NonHwhite" as reference

control = "ancestryPC_ses"
threshold = 0.05/10/13
threshold_med = 0.05
#' ### controls: 
#' 
...
color3_and_race3_bespoke_29.03.2021 <- readRDS("/home/xu/ses-1/user_wx/color3_and_race3_bespoke_29.03.2021.rds")
bespoke = color3_and_race3_bespoke_29.03.2021%>% filter(table1 %>% str_detect("aging|whole_genome"))
mediators = 
  c(
    "stress_perceived_lm",
    "bills_binary",
