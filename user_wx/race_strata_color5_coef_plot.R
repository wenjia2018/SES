...
bespoke <- readRDS("~/ses-1/user_wx/color5_NonHwhite_strata_bespoke_withtubepregV3.rds")

outomni = p_eqtl %>% map(outttT, control)
...
#+ echo=F, eval=T, warning=FALSE, message=FALSE
  bespoke <- readRDS("~/ses-1/user_wx/color5_NonHblack_strata_bespoke_withtubepregV3.rds")
