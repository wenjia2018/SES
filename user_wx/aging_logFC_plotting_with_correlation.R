#' ---
#' title: skincolor3 Aging signature logFC plotting accounting for correlation
...
logFC_ploting = function(example, p_eqtl, cor_coef){
  ...
  a %>% 
    ...
    labs(caption = paste("p_eqtl = ", p_eqtl,",","correlation = ", cor_coef))
...
p_eqtl = 0.01
logFC_ploting(example = example, p_eqtl = p_eqtl, cor_coef = 0.1)
logFC_ploting(example = example, p_eqtl = p_eqtl, cor_coef = 0.2)
logFC_ploting(example = example, p_eqtl = p_eqtl, cor_coef = 0.4)
...
logFC_ploting(example = example, p_eqtl = p_eqtl, cor_coef = 0.1)
logFC_ploting(example = example, p_eqtl = p_eqtl, cor_coef = 0.2)
logFC_ploting(example = example, p_eqtl = p_eqtl, cor_coef = 0.3)
