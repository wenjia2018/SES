...
#' ---
#' title: skin color 3 levels with basic control for disease signatures
...
library(here)
library(tidyverse)
example_skincolor3_FE <- readRDS("~/ses-1/user_wx/example_skincolor3_disease_FE_04.05.2021.rds")
example_skincolor_binaryandconti_FE <- readRDS("~/ses-1/user_wx/example_skincolor_binaryandcontinuous_disease_FE_04.05.2021.rds")

example_skincolor3_FE %>% 
  rbind(example_skincolor_binaryandconti_FE) %>% 
