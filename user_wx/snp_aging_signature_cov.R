...
#' ## among nonhispanic black

#' ### 3 omnibus with aging composite ancestry controls
#+ echo=F, eval=T, warning=FALSE, message=FALSE, fig.width=10, fig.height=8
outomni = p_eqtl %>% map(m8_present, control, snp_NonHblack)
...
outm71 = p_eqtl %>% map(outm7pca_anova, control, snp_NonHblack)
...
#' ### 5 omnibus with aging composite ancestry controls
#+ echo=F, eval=T, warning=FALSE, message=FALSE, fig.width=10, fig.height=8
