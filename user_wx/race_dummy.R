...
custom_PCA <- readRDS("/home/share/dna_ancestry/dna/custom_PCA.rds")
...
example0 %>% saveRDS("./user_wx/example_race_dummy_26.11.rds") 
...
# 
# # with ancestry pca by us
# example1 %>% saveRDS("./user_wx/race_detfbm_dummy_26.11.rds")
