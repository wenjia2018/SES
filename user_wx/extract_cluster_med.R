...
mediate_cluster <- readRDS("~/ses-1/user_wx/mediate_cluster_with1k_v2.rds")
# mediate_cluster <- readRDS("~/ses-1/user_wx/mediate_cluster.rds")
# mediate_cluster_disesemissingdpart <- readRDS("~/ses-1/user_wx/mediate_cluster_disesemissingdpart.rds")

mediate_cluster <- readRDS("~/ses-1/user_wx/mediate_cluster_without1k.rds")
mediate_cluster<- readRDS("~/ses-1/user_wx/mediate_cluster_DeNovo.rds")
mediators = 
  c(
    "stress_perceived_lm",
    "bills_binary",
...
# missing = 
#   mediate_cluster_disesemissingdpart %>%
#   med_out_all() %>%
#   mutate("1KI Genes" = "With 1KI Genes" %>% as.factor(),
#          proportion = NA)
...
# %>% 
  # rbind(missing)
with %>% saveRDS("./user_wx/cluster_med_with1k.rds")

with %>% arrange(treatment, gene_set_name)%>% kableExtra::kable() %>% kableExtra::kable_styling()
