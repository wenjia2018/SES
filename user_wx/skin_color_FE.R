...
#' ### two treatments:
#' 
#' * skin color continuous: white 0,light brown 1, medium brown 2, dark brown 3, black is 4
#' * skin color binary: white, light brown and medium brown is 0, dark brown and  black is 1
#' 
...
library(here)
library(tidyverse)
example_race_with1KI <- readRDS("~/ses-1/user_wx/example_skincolor_FE_19.11.rds")
race_ge_tfbm <- readRDS("~/ses-1/user_wx/skincolor_detfbm_FE_19.11.rds")
