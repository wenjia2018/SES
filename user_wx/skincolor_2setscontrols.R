...
#' ---
#' title: skin color with basic control, and race ethnicity control
...
library(here)
library(tidyverse)
example_race_with1KI <- readRDS("~/ses-1/user_wx/example_skincolor_dummy_12.11.rds")
race_ge_tfbm <- readRDS("~/ses-1/user_wx/skincolor_detfbm_dummy_12.11.rds")
