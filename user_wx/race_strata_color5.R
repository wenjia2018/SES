...
bespoke <- readRDS("~/ses-1/user_wx/color5_NonHwhite_strata_bespoke_withtubepregV2.rds")
...
#+ echo=F, eval=T, warning=FALSE, message=FALSE
bespoke <- readRDS("~/ses-1/user_wx/color5_NonHblack_strata_bespoke_withtubepregV2.rds")
...
#+ echo=F, eval=T, warning=FALSE, message=FALSE
bespoke <- readRDS("~/ses-1/user_wx/color5_Hispanic_strata_bespoke_removetubepregnantV2.rds")
