...
#' ### treatments: 
#' * Among non hispanic black and hispanic race and Skin Color interaction model, use hispanic and lightmed as reference
#' * construct the following dummies variables(skincolor white also as 0 as there is ony one 1 white in nonhispanic black group)
#' * "color_byinterviewer3_DarkBlack", "raceethnicity_NonHblack","raceethnicity__color_byinterviewer3_NonHblack|DarkBlack"
...
color3_and_race3_NonHblackhispanic_bespoke_01.04.2021 <- readRDS("/home/xu/ses-1/user_wx/color3_and_race3_NonHblackhispanic_bespoke_01.04.2021.rds")
bespoke = color3_and_race3_NonHblackhispanic_bespoke_01.04.2021%>% filter(table1 %>% str_detect("aging|whole_genome"))
mediators = 
  c(
    "stress_perceived_lm",
    "bills_binary",
...
outm72 = p_eqtl[2] %>% map_df(outm7med, mediators, control, bespoke)
