...
#' ---
#' title: skin color3 with aging cluster complement outcome
...
# bespoke <- readRDS("/home/xu/ses-1/user_wx/color_conti_binary_dummy3and5_bespoke.rds")
bespoke <- readRDS("/home/xu/ses-1/user_wx/color3_bespoke_15.03.2021.rds")
