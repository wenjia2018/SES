...
define_treatments_and_controls_skincolor_continuous()
...
example0 %>% saveRDS("./user_wx/example_skincolor_continuous_13.11.rds") 
...
example1 =
  ...
  mutate(out = pmap(., safely(model_fit), funcs),
         controls = names(controls))
example1 %>% saveRDS("./user_wx/skincolor_detfbm_continuous_13.11.rds")
# 