...
#' ### treatments: 11 color snps


sig_snp = c("rs12203592", "rs2153271",  "rs4930263",  "rs2376558",  "rs10765819",
            "rs9971729",  "rs642742",   "rs12896399", "rs2228479", "rs1110400", "rs1805008")
control = "ancestryPC"
threshold = 0.05/10
threshold_med = 0.05
...
outm7med = function(p, mediators, control){
  out = mediators %>% 
    ...
    filter(med!="NULL", treatment %in% sig_snp) %>%
    unnest_longer(med) %>% 
    hoist(med, p = "p") %>%
