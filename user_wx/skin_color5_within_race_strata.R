...
#' ---
#' title: skin color 5 within Race strata with ancestryPC control
...
bespoke <- readRDS("/home/xu/ses-1/user_wx/color5_bespoke_NonHwhite_strata_23.02.2021.rds")
#' ### omnibus regression
#+ echo=F, eval=T, warning=FALSE, message=FALSE
...
bespoke <- readRDS("/home/xu/ses-1/user_wx/color5_bespoke_NonHblack_strata_24.02.2021.rds")
...
bespoke <- readRDS("/home/xu/ses-1/user_wx/color5_bespoke_Hispanic_strata_24.02.2021.rds")
#' ### omnibus regression
#+ echo=F, eval=T, warning=FALSE, message=FALSE
outomni = p_eqtl %>% map(m8_present, control, bespoke)
outomni %>%
